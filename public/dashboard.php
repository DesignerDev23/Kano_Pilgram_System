      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">User Activities</span>
            </li>

            <li class="sidebar-item">
              <a class="sidebar-link" href="./transactions.html" aria-expanded="false">
                <span>
              ...
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">My Account</h5>
                    <div class="row align-items-center">
                      <div class="col-8">
                        <h4 class="fw-semibold mb-3"><?php echo htmlspecialchars($pilgrim->account_number); ?></h4>
                        <div class="d-flex align-items-center mb-3">
                          <p class="text-dark me-1 fs-3 mb-0">Bank Name:</p>
                          <p class="fs-3 mb-0">Wema Bank</p>
                        </div>
                      </div>
                      <div class="col-4">
