...
class Pilgrim {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " (pil_name, pil_lga, pil_nin, pil_bvn, passport_no, gender, dob, phone_number, email, password, account_number) VALUES (:pil_name, :pil_lga, :pil_nin, :pil_bvn, :passport_no, :gender, :dob, :phone_number, :email, :password, :account_number)";
